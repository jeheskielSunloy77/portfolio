...
export function HeroRobot() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (head && headBaseline) {
        ...
        head.rotation.x =
          headBaseline.x + currentRef.current.y * MAX_HEAD_PITCH;
      }
  ...
  const hidePlaceholder = isLoaded && SplineComponent !== null;
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 ${hidePlaceholder ? "hidden" : ""}`}
        aria-hidden={hidePlaceholder}
      >
        <img
          src="/bot.webp"
          alt="bot placeholder"
